...
from nle_utils.wrappers import FinalStatsWrapper, NLEDemo, RenderVideo, TaskRewardsInfoWrapper, TtyrecInfoWrapper


def worker(
    seed, game: str, character: str, savedir: str, gamesavedir: str, save_video: bool, save_demo: bool, show: bool
):
    orig_env = gym.make(
        game,
        character=character,
    ...
    if save_video:
        orig_env = RenderVideo(orig_env, output_dir=gamesavedir, show=show)
    if save_demo:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_demo", type=str2bool, default=False)
